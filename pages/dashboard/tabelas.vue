<template>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
		<a class="navbar-brand" href="/dashboard">Admin Curso</a>
...
<script>
    export default {
        ...
        return {
            ...
            script: [
                { scr: './assets/bibliotecas/jquery/jquery.min.js' },
                { scr: './assets/bootstrap/js/bootstrap.bundle.min.js"' },
                { scr: './assets/jquery-easing/jquery.easing.min.js' },
                { scr: './assets/bibliotecas/datatables/jquery.dataTables.js' },
                { scr: './assets/bibliotecas/datatables/dataTables.bootstrap4.js' },
                { scr: './assets/js/sb-admin.min.js' },
                { scr: './assets/js/sb-admin-datatables.min.js' },
            ],
            css: [
                { src: './assets/bibliotecas/bootstrap/css/bootstrap.min.css' },
                { src: './assets/bibliotecas/font-awesome/css/font-awesome.min.css' },
                { src: './assets/css/sb-admin.min.css' },
            ],
    }
  },
